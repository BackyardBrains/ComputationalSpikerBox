...
#define light 12
#include <Empanada_inferencing.h> // Touch, Temp, Light
static const float features[] = {0.0000, 1787.7896, 189.2639, 0.0000, 1833.9408, 246.5599, 0.0000, 1802.4042, 190.6290, 0.0000, 1903.2751, 379.7520, 0.0000, 1898.3324, 379.0114, 0.0000, 1894.6741, 375.4221, 0.0000, 1898.7083, 377.3386, 0.0000, 1886.7473, 367.3798, 0.0000, 1857.0601, 306.8563, 0.0000, 1860.3464, 305.5268, 0.0000, 1802.1208, 203.7595, 0.0000, 1825.6265, 234.6645, 0.0000, 1782.7245, 175.4280, -7.8220, 1812.2850, 211.9267, 10.5494, 1842.3932, 244.9140, -25.0513, 1910.6895, 407.7978, 36.7031, 1881.1309, 353.8965, -63.8421, 1895.2257, 372.4898, 93.9126, 1867.4625, 299.3801, -151.6706, 1821.6497, 231.4878, 244.5046, 1873.5957, 305.8568, -485.3774, 1813.1659, 237.6422, 1930.3049, 1812.1973, 184.5766, 4199.2773, 1895.1201, 269.8515, 3390.1628, 1851.3062, 228.6868, 3809.2432, 1861.0687, 229.1574, 3589.6082, 1906.0731, 326.1385, 3764.9958, 1872.4852, 257.4203, 3694.0596, 1817.7281, 163.2824, 3740.6946, 1763.1173, 306.4515, 3714.6919, 1888.7521, 361.4553, 3632.8113, 1848.6328, 188.7314, 3702.3438, 1882.8757, 316.1705, 3440.4651, 1823.6858, 319.4190, 3430.6143, 1762.0227, 151.2189, 748.5348, 1901.7979, 353.3598, -102.6315, 1813.6948, 219.4376, 61.3696, 1786.5674, 167.9359, -41.3724, 1805.4956, 212.2181, 24.8071, 1818.7664, 183.5836
};
float features1[120];
float maxValue = 0;
String category = "0";
...
int raw_feature_get_data(size_t offset, size_t length, float *out_ptr) {
  ...
  for (byte i = 0; i < 117; i = i + 2) {
    features1[i] = features1[i + 3];
  ...
  delay(50);  // Enables Fast? //Sorry Alex
  features1[117] = analogRead(FSR);
  //   Serial.println(features1[78]); // Debug
  features1[118] = analogRead(temperature);
  features1[119] = analogRead(light);
...
*/
  ...
  for (int i = 0; i < 120; i++) {
    ...
    i = i + 1;
    features1[i] = analogRead(temperature);
    i = i + 1;
